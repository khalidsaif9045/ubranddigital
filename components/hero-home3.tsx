    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="py-8 md:py-20">
          {/* Section header */}
          <TextReveal className="text-white" speed={3}>You are an expert and still invisible online not because you lack skills, but because you never learn how to show up.</TextReveal>

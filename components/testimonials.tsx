...
const testimonials = [
  {
    ...
    company: "",
    content:
      "I had the pleasure of consulting with Mohd, and it completely transformed the way I approach LinkedIn. Mohd has a deep, tactical understanding of how the platform works. From the algorithm to content strategy to visibility. He doesn’t just share tips; he teaches you how to think about LinkedIn as a growth engine. Thanks to him, I now show up more intentionally, know what to post, and understand how to get meaningful engagement. If you're serious about building your presence on LinkedIn, I highly recommend connecting with Mohd. He makes the complex simple, and gives you the confidence to show up consistently.",
    categories: [1, 2, 5],
  },
  {
    img: TestimonialImg01,
    clientImg: ClientImg01,
    name: "Norbert Bezzina",
    company: "",
    content:
      "Hashim is super smart when it comes to LinkedIn. I’ve worked with him and joined two of his live events. He understands how LinkedIn works and what people like. He mixes smart ideas with a human touch. If you're starting on LinkedIn and need help, Hashim is the best person to guide you. I highly recommend Hashim, both professionally and personally.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "",
    content:
      "Having worked with Hashim, he's had a big impact on how I show up on LinkedIn. He brought a thoughtful, strategic perspective that helped me better align my presence with the audience I want to reach. He's collaborative, insightful, and always thinking a few steps ahead. The results speak for themselves—more visibility, better conversations, and stronger connections. I'd highly recommend him to anyone looking to level up their approach on the platform.",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "",
    content:
      "I hired Hashim when my LinkedIn account hit a stagnant phase, and he absolutely crushed it. He boosted my engagement, increased impressions, and helped build a real community around my profile. I started getting way more DMs and noticed a huge difference in my overall LinkedIn presence. If you’re looking to grow your account, Hashim is the one to go to!",
    categories: [1, 4],
  },
  {
    ...
    company: "",
    content:
      "I’ve been working with Mariyum for a while now, and she’s truly a LinkedIn mastermind. It’s not just about writing for her; she listens, absorbs, and turns thoughts into content that truly connects. If you want LinkedIn content or branding that stands out and speaks directly to your audience, Mariyum is the one you need. I'm so happy to always have her as a part of my team.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "",
    content:
      "Imagine working with someone who delivers ahead of time, produces high-quality work and is a pleasure to collaborate with. That’s exactly what you get when working with Mariyum. I’ve always admired her beautiful designs and valuable insights on LinkedIn growth, and our collaboration only reinforced that. Mariyum was easy to communicate with, receptive to feedback and delivered stunning work. Plus, she’s just a genuinely great person to work with. If you’re looking for someone reliable, talented and fun to collaborate with while ensuring top-quality results, she’s the right choice!",
    categories: [1, 3],
  },
  // {
